...
<template>
  <div
    class="relative aspect-video rounded-3xl overflow-hidden shadow-md group bg-[#fefae0]"
  >
    <img
    ...
    <div class="absolute bottom-0 inset-x-0 p-4 z-10">
      <div class="backdrop-blur-md bg-black/50 rounded-xl p-4 space-y-2">
        ...
        <button
          class="btn btn-sm bg-base-200 text-base-content border-none hover:bg-base-300"
          @click="openPlayer"
        >
          Commencer
        </button>
